...
db.restaurants.find({"borough": "Bronx", $nor: [{"cuisine": /American/}, {"cuisine": /Chinese/}]});
...
db.restaurants.find({$or: [{"name": /^Wil/}, {$and: [{"cuisine": /Seafood/}, {$nor: [{"cuisine":/American/}, {"cuisine": /Chinese/}]}]}]},{"restaurant_id":1, "name":1, "borough":1, "cuisine":1, "_id":0});
...
db.restaurants.find({$and: [{"address.coord.1": {$gt: 42}}, {"address.coord.1": {$lte: 52}}]},{"restaurant_id":1, "name":1, "address":1, "_id":0});
...
db.restaurants.find({"address.street": null},{"address":1,"_id":0});
